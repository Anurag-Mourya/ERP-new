...
const BasicDetails = ({ updateUserData, switchCusData, text1, customerData, tick, setTick }) => {
                ...
                <div id="secondx2_customer">
                    <div id="main_forms_desigin_cus">
                        ...
                        <div className="form_commonblockx2">
                            <label> {text1} Type<b className='color_red'>*</b></label>
                        ...
                        <div className="sections">
                            <div id="fcx3s1parent">
                                ...
                                <div className="form_commonblockx3">
                                    <label>{text1} Name<b className='color_red'>*</b></label>
                                    <div id="fcx3s1">
                                        <span>
                                        ...
                                        <span>
                                            <input type="input" name="first_name" value={basicDetails.first_name} onChange={handleChange} placeholder={`Enter ${text1} first name`} />
                                        </span>


                                        <span><input type="input" name="last_name" value={basicDetails.last_name} onChange={handleChange} placeholder={`Enter ${text1} last name`} /></span>
                                    </div>
                                ...
                                <div className="form_commonblock">
                                    ...
                                    <span>
                                        ...
                                        <input type="email" name="email" value={basicDetails.email} onChange={handleChange} placeholder={`Enter ${text1} email`} />
                                    </span>
                                </div>
