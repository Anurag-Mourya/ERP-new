...
const InsideItemDetailsBox = ({ itemDetails }) => {
 ...
 <div className="buttonscontainxs2">
        ...
        <div
          className={`divac12cs32 ${activeSection === 'history' ? 'activediv12cs' : ''}`}
          ...
          <>
            <div className="inidbx1">
              <div className="inidbx1s1">
                ...
                <ul>
                  <li><span>Item type</span><h1>:</h1><p>Sales items</p></li>
                  <li><span>SKU</span><h1>:</h1><p>Items 1SKU</p></li>
                  <li><span>SAC</span><h1>:</h1><p>307704</p></li>
                  <li><span>Unit</span><h1>:</h1><p>Meter</p></li>
                  <li><span>UPC</span><h1>:</h1><p>Item 1 upc</p></li>
                  <li><span>EAN</span><h1>:</h1><p>items</p></li>
                  <li><span>ISBN</span><h1>:</h1><p>Item 1isbn</p></li>
                  <li><span>Created source</span><h1>:</h1><p>User</p></li>
