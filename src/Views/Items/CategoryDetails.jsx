...
const CategoryDetails = () => {
  ...
  return (
    <>
      ...
      {deleteLoading && <MainScreenFreezeLoader />}

      <Toaster />
      {subCategoryList?.loading ? <Loader02 />
        :
        <>
          {notFound ? (
                ...
                <>
                  <div id="Anotherbox" className='formsectionx1'>
                    ...
                    <div id="buttonsdata">
                      ...
                      <CreateCategoryPopup showPopup={showPopup} setShowPopup={setShowPopup} categoryData={subCategoryList?.data?.data[0]} />
                      ...
                      <li><span>Subcategories</span><h1>:</h1>
                        <p className="subcatelsica5s">
                          ...
                          <div className="addbuttonsubcat">
                            <Link to={`/dashboard/create-categories?cat_id=${subCategoryList?.data?.data[0]?.id}`}><GoPlus /> Add</Link>
                          </div>
                        </p>
                      </li>
                    </ul>
