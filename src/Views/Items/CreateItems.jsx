...
const CreateAndUpdateItem = () => {
  ...
  return (
    ...
    <Tooltip id="my-tooltip" />
      ...
      <div id="Anotherbox">
        ...
        <div id="buttonsdata">
          <Link data-tooltip-id="my-tooltip" data-tooltip-content="Hello world!" to={"/dashboard/manage-items"} className="linkx3">
          <RxCross2 />
          </Link>
        </div>
      </div>
  ...
  <span>
    ...
    <div className="form-group">
                ...
                <span>
                  {/* <CiEdit /> */}
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#7c7c7c"} fill={"none"}>
