...
const CreateAndUpdateItem = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (itemId && isEdit) {
            dispatch(addItems({ ...formData, id: itemId, preferred_vendor: JSON?.stringify(formData?.preferred_vendor) }));
        } else if (itemId && isDublicate) {
            dispatch(addItems({ ...formData, id: 0, preferred_vendor: JSON?.stringify(formData?.preferred_vendor) }));
        } else {
            dispatch(addItems({ ...formData, id: 0, preferred_vendor: JSON?.stringify(formData?.preferred_vendor) }));
        }
    ...
    useEffect(() => {
        // Show toast message only when handleSubmit has run
        if (formSubmitted) {
    ...
    }, [formSubmitted, itemCreatedData?.addItemsResponse]);
                                        ...
                                        <div className="secondx2">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <span>
                                                    ...
                                                    <input className={formData.sku ? 'filledcolorIn' : null} type="text" name="sku" placeholder='Enter SKU' value={formData.sku} onChange={handleChange} />
                                                </span>
                                            </div>
                                            <div className="form-group">
                                                    ...
                                                    <div className="file-upload">
...

                                                        {
                                                            imgLoader === "success" && item_details?.image_url !== null ?
                                                                <label className='imageviewico656s' htmlFor="" data-tooltip-id="my-tooltip" data-tooltip-content="View Item Image" onClick={showimagepopup} ><BsEye /></label> : ""
                                                        }
                                                    </div>
                                                </div>
