  ...
  const handleItemInputChange = (e, index, fieldName) => {
    ...
    if (selectedItem) {
      if (fieldName === 'quantity') {
        const taxAmount = (parseFloat(selectedItem.price) * parseFloat(value) * parseFloat(selectedItem.tax_rate)) / 100;
        updatedItems[index].gross_amount = parseFloat(selectedItem.price) * parseFloat(value);
        updatedItems[index].tax_amount = taxAmount;
        updatedItems[index].final_amount = (parseFloat(selectedItem.price) * parseFloat(value) + taxAmount) - parseFloat(updatedItems[index].discount);
              ...
              <div id="thirdformcls25">
                ...
                <div className="cjslw4s2">
                  ...
                  <div className='group-form'>
                    ...
                    <span>
                      <IoPersonOutline className='svgofsecon65xs6' /><input type="number" value={formData.payment_terms} onChange={(e) => setFormData({ ...formData, payment_terms: e.target.value })} />
                    </span>
                  </div>
                </div>
