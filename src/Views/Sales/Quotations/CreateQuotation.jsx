...
const CreateQuotation = () => {
    ...
    <path d="M20.5581 3.49381L11.0488 13.059M20.5581 3.49381C20.064 2.99905 16.7356 3.04517 16.032 3.05518M20.5581 3.49381C21.0521 3.98857 21.0061 7.3215 20.9961 8.02611" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <div className="form_commonblock highlighteddiv">
                            <label >reference<b className='color_red'>*</b></label>
                            <span >
                            {otherIcons.placeofsupply_svg}
                            <input type="text" value={formData.place_of_supply} onChange={(e) => setFormData({ ...formData, place_of_supply: e.target.value })}
                                disabled  required
                        ...
                        <div className="form_commonblock highlighteddiv">
                            ...
                            {otherIcons.placeofsupply_svg}
                            <input type="text" value={formData.place_of_supply} onChange={(e) => setFormData({ ...formData, place_of_supply: e.target.value })}
                                disabled placeholder='Enter Subject' />
                             </span>
                        </div>
                                                    ...
                                                    <div className="file-upload">
                                                        ...
                                                        <label htmlFor="file" className="file-label">
                                                            <div id='spc5s6'>
                                                                ...
                                                                {/* {formData.image_url !== "0" ? formData.image_url.name : 'Browse Files'} */}
                                                                Browse Files
                                                            </div>
                                                        </label>
