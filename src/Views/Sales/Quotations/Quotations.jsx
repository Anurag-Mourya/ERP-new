            ...
            <div className="maincontainmiainx1">
              ...
              {isSortByDropdownOpen && (
                <div className="dropdowncontentofx35" ref={sortDropdownRef}>
                  <div className={`dmncstomx1 ${selectedSortBy === 'Normal' ? 'activedmc' : ''}`} onClick={() => handleSortBySelection('Normal')}>All Quotation</div>
                  ...
                  <p className="custtypestext4s">Quotation number</p>
                  <label>
                    <input
                      type="checkbox"
