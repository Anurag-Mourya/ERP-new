...
const PurchaseOrder = () => {
    ...
    useEffect(() => {
        const areAllRowsSelected = qutList?.data?.purchase_order?.every((row) => selectedRows.includes(row.id));
        setSelectAll(areAllRowsSelected);
    }, [selectedRows, qutList?.data]);

    const handleSelectAllChange = () => {
        setSelectAll(!selectAll);
        setSelectedRows(selectAll ? [] : qutList?.data?.purchase_order?.map((row) => row.id));
    };
    //logic for checkBox...
            ...
            <div id="middlesection" >
                <div id="Anotherbox">
                    <div id="leftareax12">
                        ...
                        <p id="firsttagp">{qutList?.data?.purchase_order?.length} records</p>
                        <div id="searchbox">
                            <input
                    ...
                    <div id="buttonsdata">
                        ...
                        <Link className="linkx1" to={"/dashboard/create-purchases"}>
                            New Purchase <GoPlus />
                        </Link>
                    </div>
                </div>
                        ...
                        <div id="item-listsforcontainer">
                            <div id="newtableofagtheme">
                                ...
                                {qutList?.loading || dataChanging === true ? (
                                    ...
                                    <PaginationComponent
                                        itemList={qutList?.data?.purchase_order?.length}
