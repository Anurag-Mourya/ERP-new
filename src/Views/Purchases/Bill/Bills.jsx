...
const Quotations = () => {
  ...
  useEffect(() => {
    const areAllRowsSelected = billList?.data?.every((row) => selectedRows.includes(row.id));
    setSelectAll(areAllRowsSelected);
  }, [selectedRows, billList?.data]);

  const handleSelectAllChange = () => {
    setSelectAll(!selectAll);
    setSelectedRows(selectAll ? [] : billList?.data?.map((row) => row.id));
  };
  //logic for checkBox...
      ...
      <div id="middlesection" >
        <div id="Anotherbox">
          <div id="leftareax12">
            ...
            <p id="firsttagp">{billList?.data?.length} records</p>
            <div id="searchbox">
              <input
          ...
          <div id="buttonsdata">
            ...
            <Link className="linkx1" to={"/dashboard/create-bills"}>
              New Bill <GoPlus />
            </Link>
          </div>
        </div>
            ...
            <div id="item-listsforcontainer">
              <div id="newtableofagtheme">
                ...
                {billList?.loading || dataChanging === true ? (
                  ...
                  {billList?.data?.map((quotation, index) => (
