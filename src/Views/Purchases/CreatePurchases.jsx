...
const CreatePurchases = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        terms: 'terms text area',
        fy: 2024,
        currency: "USD",
        subtotal: 0,
        shipping_charge: 0,//to fill auto
        adjustment_charge: 0,//to fill auto
        total: 0,//to fill auto
        discount: 0,//to fill auto
        tcs: 0,//to fill auto
        items: []
    });
    ...
    const handleItemSelect = (itemId, index) => {
        ...
        if (selectedItem) {
            const updatedItems = [...formData.items];//total selected items in a row or formdata.items
    ...
    // console.log("formData", formData.items[0])
    ...
    const handleItemInputChange = (e, index, fieldName) => {
        ...
        if (selectedItem) {
            if (fieldName === 'quantity') {
                ...
                updatedItems[index].final_amount = (parseFloat(selectedItem.price) * parseFloat(updatedItems[index].quantity) + updatedItems[index].tax_amount) - parseFloat(value);
                            ...
                            <div id="thirdformcls25">
                                <div className="cjslw4s2">
                                    ...
                                    {/* <div className='group-form'>
                                        ...
                                        <span>
                                            <IoDocumentTextOutline className='svgofsecon65xs6' /><input type="text" value={formData.terms} onChange={(e) => setFormData({ ...formData, terms: e.target.value })} />
                                        </span>
                                    </div> */}
                                ...
                                <div className="cjslw4s2">
                                    <div className='group-form'>
                                        <label className='redcolortext'>reference_no</label>
                                        <span>
                                    ...
                                    <div className='group-form'>
                                        <label className='redcolortext'>Purchad Order Id:</label>
                                        <span>
                                            <IoDocumentTextOutline className='svgofsecon65xs6' />
                                            <input
                                                type="text"
                                ...
                                <div className="cjslw4s2">
                                    <div className='group-form'>
                                        <label className='redcolortext'>Purchase Date:</label>
                                        <span>
