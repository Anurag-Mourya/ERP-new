...
const EditPurchases = () => {
    ...
    console.log("fetchPurchases", fetchPurchases)
    ...
    useEffect(() => {
        setFormData({
            ...
            reference_no: fetchPurchases?.reference_no,
            purchase_order_id: fetchPurchases?.purchase_order_id,
        ...
        setItems(finalItems);
    }, [vendors, fetchPurchases?.transaction_date, fetchPurchases?.terms, fetchPurchases?.vendor_id, fetchPurchases?.vendor_name, fetchPurchases?.phone, fetchPurchases?.reference_no, fetchPurchases?.purchase_order_id, fetchPurchases?.transaction_date, fetchPurchases?.expiry_date, fetchPurchases?.email, fetchPurchases?.vendor_note,
        fetchPurchases?.fy,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.message === 'Transaction Created Successfully') {
                toast.success('Purchased successfully Updated');
                setLoading(false);
            }
            ...
            setLoading(false);
            toast.error('Error creating Purchases:', error);
    ...
    const fetchAllPurchases = async () => {
        try {
            const getData = await axiosInstance.post(`/purchase-order/details?id=${id}`, {
            });
            setFetchPurchases(getData?.data?.purchaseOrder)
        } catch (e) {
            ...
            <div id='middlesection'>
                ...
                <div id="Anotherbox">
                    <h1 id='firstheading'>
                        ...
                        Create a Purchases</h1 >

                    <div id="buttonsdata">
                        <Link to={"/dashboard/purchase"}>Manage Purchases <GrFormNextLink /></Link>
                    ...
                    <div id='parentnewformmodern' onKeyDown={handleKeyDown}>
                        ...
                        <div id="newformmodern">
                            ...
                            <div id="thirdformcls25">
                                ...
                                <div className="cjslw4s2">
                                    <div className='group-form'>
                                        <label className='redcolortext'>Reference no.</label>
                                        <span>
                                    ...
                                    <div className='group-form'>
                                        <label className='redcolortext'>Purchase order ID</label>
                                        <span>
                                            <IoDocumentTextOutline className='svgofsecon65xs6' />
                                            <input
                                                type="text"
                                ...
                                <div className="cjslw4s2">
                                    <div className='group-form'>
                                        <label className='redcolortext'>Purchased Date:</label>
                                        <span>
