...
import { creditNoteLists, debitNoteLists, invoiceLists, quotationLists, saleOrderLists } from "../../../Redux/Actions/listApisActions";
            ...
            <div className="maincontainmiainx1">
              ...
              {isSortByDropdownOpen && (
                ...
                <div className="dropdowncontentofx35" ref={sortDropdownRef}>
                  ...
                  <div className={`dmncstomx1 ${selectedSortBy === 'debit_note_id' ? 'activedmc' : ''}`} onClick={() => handleSortBySelection('debit_note_id')}>Debit Note</div>
            ...
            <div className="maincontainmiainx1">
              ...
              {isFilterDropdownOpen && (
                <div className="dropdowncontentofx35" ref={filterDropdownRef}>
                  ...
                  <div className={`dmncstomx1 ${status === 'Normal' ? 'activedmc' : ''}`} onClick={() => handleFilterSelection('Normal')}>All Debit Notes</div>

                  <div className={`dmncstomx1 ${status === '1' ? 'activedmc' : ''}`} onClick={() => handleFilterSelection('1')}>Open</div>

                  <div className={`dmncstomx1 ${status === '0' ? 'activedmc' : ''}`} onClick={() => handleFilterSelection('0')}>Close</div>

                  <div className={`dmncstomx1 ${status === '2' ? 'activedmc' : ''}`} onClick={() => handleFilterSelection('2')}>Over Due</div>

                  <div className={`dmncstomx1 ${status === '3' ? 'activedmc' : ''}`} onClick={() => handleFilterSelection('3')}>Pending</div>
                </div>
              )}
